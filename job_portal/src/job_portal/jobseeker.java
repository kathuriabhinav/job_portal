...
public class jobseeker {
    ...
    private static class register_jobseeker {
    ...
    private static class login_jobseeker {

        public login_jobseeker() {
	     ...
	     b7.addActionListener( new ActionListener() {
	        ...
	        {
                    new login(t9.getText(),t10.getText(),2);
